...
void WalkingModule::angleCorrection(const sensor_msgs::Imu::ConstPtr &imu){
  Eigen::Quaterniond q = Eigen::Quaterniond(imu->orientation.x, imu->orientation.y, imu->orientation.z, imu->orientation.w);
